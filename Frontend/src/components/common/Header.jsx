    ...
    <>
      <div className="bg-[#1B6392]">
        ...
        <div className="flex max-w-[1020px] h-[88px] justify-center items-center mx-auto">
          ...
          <div className="flex grow items-center md:mx-24 h-10 relative rounded-md overflow-hidden">
