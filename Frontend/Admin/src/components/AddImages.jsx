        ...
        <label className="cursor-pointer flex justify-center">
          ...
          <div className="bg-gray-200 w-16 h-16 flex items-center justify-center rounded-md cursor-pointer">
            ...
            >
              <path
                fillRule="evenodd"
                d="M10 18a8 8 0 100-16 8 8 0 000 16zm0 1a9 9 0 110-18 9 9 0 010 18zm5.707-12.293a1 1 0 01-1.414 1.414L11 8.414V14a1 1 0 11-2 0V8.414L5.707 7.121a1 1 0 10-1.414 1.414L10 15.414l5.707-5.707a1 1 0 011.414 0z"
                clipRule="evenodd"
              />
            </svg>
          </div>
