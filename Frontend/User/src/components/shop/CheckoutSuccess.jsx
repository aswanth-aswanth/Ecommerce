    ...
    <div className="flex justify-center items-center  min-h-[50vh]">
      <div className="flex flex-col items-center py-10">
        ...
        <div className="flex gap-6 text-sm font-bold">
          <button onClick={()=>navigate('/dashboard')} className="border border-[#ffab6f] text-[#FA8232]  py-3 px-4">Go to Dashboard</button>
          <button className="bg-[#FA8232] text-white py-3 px-4">VIEW ORDER</button>
        </div>
      </div>
    </div>
  );
