    ...
    <div className="bg-white p-8 shadow-md rounded-md max-w-3xl mx-auto text-[#566A7F]">
      ...
      <div className="flex mb-4">
        ...
        <div className="w-1/2 pl-2">
          ...
          <input type="text" className="w-full border border-gray-300 p-2" onChange={(e) => handleInputChange("category", e.target.value)} />
        </div>
      </div>
      ...
      <div className="flex mb-4">
        <div className="w-1/2 pr-2">
          ...
          <input type="text" className="w-full border border-gray-300 p-2" onChange={(e) => handleInputChange("productVariant", e.target.value)} />
        </div>
        <div className="w-1/2 pl-2">
          <label className="block text-sm font-semibold mb-1">Color</label>
          <input type="text" className="w-full border border-gray-300 p-2" onChange={(e) => handleInputChange("color", e.target.value)} />
        </div>
      </div>
